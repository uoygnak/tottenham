			...
			.ready(
					function() {
						...
						$(".update_btn").on("click", function() {
							formObj.attr("action", "/insa/updateView");
						...
						$(".delete_btn").on("click", function() {
							...
							if (deleteYN == true) {
								...
								formObj.attr("action", "/insa/delete");
						...
						$(".list_btn")
								.on(
										...
										function() {
											...
											location.href = "/insa/list?page=${scri.page}"
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/insa/replyWrite");
							formObj.submit();
						});
						...
						$(".replyUpdateBtn")
								.on(
										"click",
										function() {
											location.href = "/insa/replyUpdateView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
						...
						$(".replyDeleteBtn")
								.on(
										"click",
										function() {
											location.href = "/insa/replyDeleteView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
													+ "&searchType=${scri.searchType}"
													+ "&keyword=${scri.keyword}"
