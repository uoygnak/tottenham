						...
						$(".cancel_btn")
								.on(
										...
										function() {
											...
											location.href = "/gongji/readView?bno=${update.bno}"
													+ "&page=${scri.page}"
	...
	<div id="root">
		...
		<section id="container">
			<form name="updateForm" role="form" method="post"
				onsubmit="return chkSubmit()" action="/gongji/update">
						...
						<div class="row">
							...
							<div class="col-md-10">
								<div class="form-group">
									<label for="title">제목</label> <input type="text"
										class="form-control chk" name="title" id="title"
							...
							<div class="col-md-10">
								<div class="form-group">
									...
									<textarea class="form-control chk" rows="10" name="content"
										id="content">
