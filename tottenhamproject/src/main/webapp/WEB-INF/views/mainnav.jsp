...
<script type="text/javascript">
  ...
  <div style=" position: absolute; right: 100px; top: 10px;">
	  <c:if test="${member.mem_id == null}">
	       <h4 style = "color:#FFFFFF"><a href="/login" style = "color:#FFFFFF">로그인</a> / <a href="/member/register" style = "color:#FFFFFF">회원가입</a></h4>
	      </c:if>
        <c:if test="${member.mem_id != null}">
				<li class="dropdown">
	        <h4 style = "color:#FFFFFF"><a href="#" style = "color:#FFFFFF" class="dropdown-toggle" data-toggle="dropdown">마이페이지<b class="caret"></b></a></h4>
        ...
        <c:if test="${member.mem_id == 'admin'}">
         <li>
        <h4 style = "color:#FFFFFF"><a href="/manager/memberlist" style = "color:#FFFFFF">관리자</a></h4>
        </li>
        </c:if>
	</div>
    ...
    <div class="navbar-header">
     ...
     <img alt="brand" src="/resources/img/logo2_white.png" style=" position: absolute; width:40px; left: 100px;">
      </a>
    </div>
    <br>
