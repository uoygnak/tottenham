		...
		<section id="container">
			<form action="/member/memberDelete" method="post" id="delForm">
				<div class="form-group has-feedback">
					...
					<input class="form-control" type="text" id="mem_id" name="mem_id" value="${member.mem_id}" readonly="readonly"/>
				</div>
				<div class="form-group has-feedback">
				...
				<div class="form-group has-feedback">
					...
					<input class="form-control" type="text" id="userName" name="userName" value="${member.mem_name}" readonly="readonly"/>
				</div>
			</form>
			<div class="form-group has-feedback">
