...
async : true, 
type : 'POST' ,
data : mem_id, // mem_id 라는 이름으로 mem_id라는 데이터를 @webservlet("/idsearch.do")에 보내겠다.
url : '/member/idChk',
dataType:'json', 
...
<form action="/member/memberUpdate" method="post" role ="form" id="usercheck" name="member">
<br><br>
...
<div class="form-group has-feedback">
<label class="control-label" for="mem_pw">비밀번호</label> 
<input class="form-control" type="password" id="mem_pw" name="mem_pw" placeholder="PASSWORD"/>
<div class="eheck_font" id="pw_check"></div>
</div>

<div class="form-group has-feedback">
<label class="control-label" for="mem_pw2">비밀번호확인</label> 
<input class="form-control" type="password" id="mem_pw2" name="mem_pw2" placeholder="Confirm PASSWORD" />
<div class="eheck_font" id="pw2_check"></div>
</div> 


<div class="form-group has-feedback">
<label class="control-label" for="mem_name">이름</label> 
<input class="form-control" type="text" id="mem_name" name="mem_name" 
value="${member.mem_name}" readonly="readonly" />

<div class="form-group has-feedback">
<label class="control-label" for="mem_birth">생년월일</label> 
<input class="form-control" type="tel" id="mem_birth" name="mem_birth" 
value="${member.mem_birth}" readonly="readonly" />


<div class="form-group has-feedback">
<label class="control-label" for="mem_email">이메일 주소</label> 
...
<div class="form-group has-feedback">
<label class="control-label" for="mem_email">휴대폰 번호('-'없이 번호만 입력해주세요)</label> 
...
<div class="form-group has-feedback">
<lavel class="control-label" for="mem_gender">성별</lable>
<input type="radio" id = "mem_gender" name="mem_gender" value="${member.mem_gender}" checked="${member.mem_gender}">남
<input type="radio" id = "mem_gender" name="mem_gender" value="${member.mem_gender}" checked="${member.mem_gender}">여
</div>

<div class="form-group">
<input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호" 
name = "mem_oaddress" id = "mem_oaddress" type="text" value="${member.mem_oaddress}" readonly="readonly">
...
name="mem_address" id="mem_address" type ="text" value="${member.mem_address}" readonly="readonly"/>
</div>


<div class = "form-group">
<input class="form-control" placeholder="상세주소" name="mem_detailaddress" 
id="mem_detailaddress" type="text" value="${member.mem_detailaddress}" />
</div>
