			...
			.ready(
					function() {
						...
						$(".update_btn").on("click", function() {
							formObj.attr("action", "/qa/updateView");
						...
						$(".list_btn")
								.on(
										...
										function() {
											...
											location.href = "/qa/list?page=${scri.page}"
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/qa/replyWrite");
							formObj.submit();
						});
						...
						$(".replyUpdateBtn")
								.on(
										"click",
										function() {
											location.href = "/qa/replyUpdateView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
						...
						$(".replyDeleteBtn")
								.on(
										"click",
										function() {
											location.href = "/qa/replyDeleteView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
													+ "&searchType=${scri.searchType}"
													+ "&keyword=${scri.keyword}"
	...
	<div class="container">
		...
		<section id="container">
			...
			<div class="form-group">
				<div class="form-group">
					<label for="writer" class="col-sm-2 control-label">작성자</label> <br>
					<br> <input type="text" id="writer" name="writer"
						class="form-control" value="${read.writer}" readonly="readonly"
						style="border: inset 1px silver;" />
				</div>

				<div class="form-group">
					<label for="title" class="col-sm-2 control-label">제목</label> <br>
					<br> <input type="text" id="title" name="title"
						class="form-control" value="${read.title}" readonly="readonly"
						style="border: inset 1px silver;" />
				</div>

				<label for="content" class="col-sm-2 control-label">내용</label> <br>
				<br>
				<div id="content" name="content" class="form-control"
					readonly="readonly" rows="10"
					style="border: inset 1px silver; height: 600px; padding: 1 1 1 1; font-size: 25pt; overflow: auto; border-radius: 10px;">
					${read.content}</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="writer" name="writer"
									class="form-control" value="${member.mem_id}"
									readonly="readonly" style="border: inset 1px silver;" />
							</div>
						</div>
