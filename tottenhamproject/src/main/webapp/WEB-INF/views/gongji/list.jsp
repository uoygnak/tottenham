				...
				<table id="list" class="table table-hover">
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td><a
								href="/gongji/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out
					...
					<c:if test="${member.mem_id == 'admin'}">
						<li><a href="/gongji/writeView">글 작성</a></li>
					</c:if>
				</table>
