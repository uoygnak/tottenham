...
#content img { max-width:1500px; height:auto; display:block; margin: 0px auto; }
</style>
</head>
			...
			.ready(
					function() {
						...
						$(".update_btn").on("click", function() {
							formObj.attr("action", "/gongji/updateView");
						...
						$(".delete_btn").on("click", function() {
							...
							if (deleteYN == true) {
								...
								formObj.attr("action", "/gongji/delete");
						...
						$(".list_btn")
								.on(
										...
										function() {
											...
											location.href = "/gongji/list?page=${scri.page}"
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/gongji/replyWrite");
							formObj.submit();
						});
...
<br><br><br>
	<div class="container">
		...
		<section id="container">
			...
			<button type="button" class="list_btn btn btn btn-default">목록</button>
				</div>
