				...
				<table id="list" class="table table-hover">
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td><a
								href="/jaryo/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out
					...
					<li><a href="/jaryo/writeView">글 작성</a></li>
				</table>
