			...
			.ready(
					function() {
						...
						$(".update_btn").on("click", function() {
							formObj.attr("action", "/cell/updateView");
						...
						$(".delete_btn").on("click", function() {
							...
							if (deleteYN == true) {
								...
								formObj.attr("action", "/cell/delete");
						...
						$(".list_btn")
								.on(
										...
										function() {
											...
											location.href = "/cell/list?page=${scri.page}"
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/cell/replyWrite");
							formObj.submit();
						});
						...
						$(".replyUpdateBtn")
								.on(
										"click",
										function() {
											location.href = "/cell/replyUpdateView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
						...
						$(".replyDeleteBtn")
								.on(
										"click",
										function() {
											location.href = "/cell/replyDeleteView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
													+ "&searchType=${scri.searchType}"
													+ "&keyword=${scri.keyword}"
