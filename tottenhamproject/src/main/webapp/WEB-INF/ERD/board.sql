...
CREATE SEQUENCE MP_BUY_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE MP_REPLY3_SEQ INCREMENT BY 1 START WITH 1;
...
DROP TABLE MP_REPLY3;
create table mp_reply3 (
    bno number not null,
    rno number not null,
